...
public class EmployeeRepositoryIntegrationTest {
    ...
    @Test
    @DisplayName("JUnit test for save employee operation using MySQL Database")
    ...
    @Test
    @DisplayName("JUnit test for find all  employee operation using MySQL Database")
    ...
    @Test
    @DisplayName(" JUNIt test for get employee by ID using MySQL Database")
    ...
    @Test
    @DisplayName("JUNIt test for get employee by email operation using MySQL Database")
    ...
    //using MySQL Database
    @Test
    @DisplayName("JUnit test for delete employee operation using MySQL Database")
    ...
    //using MySQL Database
    @Test
    @DisplayName("JUnit test for custom query using JPQL with index using MySQL Database")
...
//using MySQL Database
    @Test
    @DisplayName("JUnit test for custom query using Name Params with index using MySQL Database")
    ...
    //using MySQL Database
    @Test
    @DisplayName("JUnit test for custom query using Custom SQL with index using MySQL Database")
    ...
    //using MySQL Database
    @Test
    @DisplayName("JUnit test for custom query using Custom SQL and Name Params with index using MySQL Database")
